...
function addListeners(){
    ...
    */
    container.addEventListener('mouseover',function(){
        TweenLite.to(cta_fpo, .5, {backgroundPosition:"-300px -100px"});
    })
...
function animate(){
    ...
    tl
    .set(c2,{opacity:0},0)
    .to(gradient,2.7,{x:-477, ease:Power0.easeNone},1.5)
    .to(gradient,2.2,{x:0, ease:Power0.easeNone },4.2)
    .from(c2a,.5,{opacity:0},4.75)
