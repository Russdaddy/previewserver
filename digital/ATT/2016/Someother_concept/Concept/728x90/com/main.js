...
function showLegals(){
    ...
    TweenLite.set($(".legalPopUp"), {x: 10, y:60, width:0, height:0, alpha:0});
 
    TweenLite.to($(".legalPopUp"), 0.5, {alpha: 1 ,ease:Expo.easeOut});
    TweenLite.to($(".legalPopUp"), 0.5, {x: 0, y: 0, width:708, height:70 , ease:Expo.easeOut});
...
function hideLegals(){
    ...
    TweenLite.to($(".legalPopUp"), 0.5, {x: 10, y:60, width:0, height:0, delay:0.2, onComplete:setDisplayNoneToLegalPopup});
